...
class FiniteVolumesSpline2(Discretization):
    ...
    def integrate_one_step(self,
        ...
        if upper_domain:
            u_interface = u_n[0] - h[0] * d[1] / 6 - h[0] * d[0] * 1 / 3
    ...
    def get_Y_star(self, M1=-1, M2=-1):
        ...
        Y_0 = -dt / (1 + dt * c) * (1 / h_m + a / (2 * D_mm1_2)) \
                    + h_m / D_mm1_2 * (1/6) * (2 - (D_minus/D_plus)*h_mp1**2 / h_m**2)
