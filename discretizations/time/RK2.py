...
class RK2(Discretization):
    ...
    def integrate_one_step(self, f, f_nm1_2, f_nm1, bd_cond, bd_cond_nm1_2, u_nm1, u_interface,
        ...
        self.update_additional(result=u_nm1, additional=additional_nm1_2, dt=self.DT/2,
                upper_domain=upper_domain, f=f_nm1, reaction_explicit=additional, coef_reaction_implicit=0) # Now additional_nm1_2 is effectively in time n-1/2

        self.update_additional(result=result_nm1_2, additional=additional, dt=self.DT,
