...
class AtmospherePadeFD():
    ...
    def integrate_large_window(self, interface,
        ...
        """
            ...
            DEBUG_LAST_VAL: set to True to get the entire profile of solution of last time.
        ...
        # Rigourously, we should add a corrective term
        ...
        for n in range(N):
            ...
            if n > 0:
                ...
                derivative_u0 = (solution[-1] - solution[-3])/(2*dt) + self.r*solution[-2]
