...
lib = ffi.dlopen("rust_tbc_parab_schwarz/target/release/librust_rate_constant.so")
def rate(discretization, N, Lambda_1=None, Lambda_2=None,
        ...
        number_seeds=10, function_D1=None, function_D2=None):
    if M1 is None:
    ...
    D1, D2 = discretization.get_D(h1=h1, h2=h2,
            function_D1=function_D1, function_D2=function_D2)
    ...
    ptr = lib.interface_err(time_window_len, Lambda_1arg, Lambda_2arg,
               aarg, carg, dtarg,
               M1arg, M2arg, h1arg, h2arg, D1arg, D2arg,
               is_finite_differences,
               number_samples)
    buf_ret = np.reshape(np.frombuffer(ffi.buffer(ptr, 8*N*3), dtype=np.float64),
                        (3, N))
...
def errors(discretization, N, Lambda_1=None, Lambda_2=None,
        a=None, c=None, dt=None, M1=None, M2=None,
        number_seeds=10, function_D1=None, function_D2=None):
    if M1 is None:
        M1 = discretization.M1_DEFAULT
...
def errors_raw(discretization, N, Lambda_1=None, Lambda_2=None,
        a=None, c=None, dt=None, M1=None, M2=None,
        number_seeds=10, function_D1=None, function_D2=None):
    if M1 is None:
        M1 = discretization.M1_DEFAULT
    ...
    ptr = lib.full_interface_err(time_window_len, Lambda_1arg, Lambda_2arg,
               ...
               is_finite_differences,
               number_samples)
    buf_ret = np.reshape(np.frombuffer(ffi.buffer(ptr, 8*N*3*number_seeds),
